...
router.get('/inventory/correct/:itemID/:siteID', authenticationMiddleware(), pageController.correct);
router.post('/inventory/correct', authenticationMiddleware(), pageController.correctAdd);
